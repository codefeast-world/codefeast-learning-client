    ...
    const scrollToSection = (sectionId: string) => {
        ...
        if (element) {
            ...
            >
                ...
                <div className='relative container mx-auto w-[85%] flex flex-col md:flex-row p-0 md:p-12 pt-20 md:pt-36 pb-16'>
                    {/* Left Sidebar */}
                    <section className='w-full md:w-[360px] p-6 flex-shrink-0'>
                        <div
